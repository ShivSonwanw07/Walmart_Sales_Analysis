...
| gross_income            | Gross Income                            | DECIMAL(12, 6) |
...
For the rest of the code, check the [WalmartSales.sql](https://github.com/ShivSonwanw07/Walmart_Sales_Analysis/blob/main/WalmartSales.sql) file
